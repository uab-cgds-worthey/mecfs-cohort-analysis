...
```{r, significant-genes-deseq, out.height="570px", out.width ="800px"}
topgenes_byensemblid_sub <- head(rownames(res_unaff_vs_unaff_df_sub), 98)
...
```{r, top50-genes-deseq, out.height="570px", out.width ="800px"}
