...
`renv` will is integrated to ensure reproducibility of this analysis.
...
genes_of_interest <- read_csv("data/Patient_Genes_2024_04_19.csv")
...
write.csv(counts_vst_limma, file = "output/counts_vst_limma_unaff.csv")
...
```{r}
res_unaff_vs_unaff_sub <- results(dds, contrast = c("Affected", "Unaffected1", "Unaffected2"))
...
topgenes_byensemblid_sub <- head(rownames(res_unaff_vs_unaff_df_sub), 31)
...
topgenes_byensemblid_sub <- head(rownames(res_unaff_vs_unaff_df_sub), 100)
topgenes_unaff_vs_unaff_05_sub <- assay(vsd_limma)[topgenes_byensemblid_sub, ]
topgenes_unaff_vs_unaff_05_sub <- topgenes_unaff_vs_unaff_05_sub - rowMeans(topgenes_unaff_vs_unaff_05_sub)
...
pheatmap(topgenes_unaff_vs_unaff_05_sub, annotation_col = df_sub, annotation_colors = ann_colors2, fontsize = 5, angle_col = 0)
```
...
pheatmap(topgenes_unaff_vs_unaff_05_sub,
...
topgenes_byensemblid_sub <- head(rownames(res_unaff_vs_unaff_df_sub), 55)
topgenes_unaff_vs_unaff_05_sub <- assay(vsd_limma)[topgenes_byensemblid_sub, ]
topgenes_unaff_vs_unaff_05_sub <- topgenes_unaff_vs_unaff_05_sub - rowMeans(topgenes_unaff_vs_unaff_05_sub)
...
topgenes_byensemblid_sub <- head(rownames(res_unaff_vs_unaff_df_sub), 75)
topgenes_unaff_vs_unaff_05_sub <- assay(vsd_limma)[topgenes_byensemblid_sub, ]
topgenes_unaff_vs_unaff_05_sub <- topgenes_unaff_vs_unaff_05_sub - rowMeans(topgenes_unaff_vs_unaff_05_sub)
...
df_sub <- as.data.frame(colData(vsd_limma)[, c("Affected", "SubCategory", "CombinedCategory")])
pheatmap(topgenes_unaff_vs_unaff_05_sub, annotation_col = df_sub, annotation_colors = ann_colors2, fontsize = 4, angle_col = 0)
```

```{r, top-200-genes-deseq-subsetted, out.height="570px", out.width ="800px"}
topgenes_byensemblid_sub <- head(rownames(res_unaff_vs_unaff_df_sub), 200)
topgenes_unaff_vs_unaff_05_sub <- assay(vsd_limma)[topgenes_byensemblid_sub, ]
topgenes_unaff_vs_unaff_05_sub <- topgenes_unaff_vs_unaff_05_sub - rowMeans(topgenes_unaff_vs_unaff_05_sub)
...
df_sub <- as.data.frame(colData(vsd_limma)[, c("Affected", "CombinedCategory")])
pheatmap(topgenes_unaff_vs_unaff_05_sub, annotation_col = df_sub, annotation_colors = ann_colors2, fontsize = 2.25, angle_col = 0)
```
...
write.csv(res_unaff_vs_unaff_df_sub_genename, file = "output/res_unaff_vs_unaff_df_sub_genename.csv")
```

```{r, top50-with-genename-padj}
res_unaff_vs_unaff_df_genename_05 <- subset(res_unaff_vs_unaff_df_sub_genename, padj < 0.05)
...
write.csv(res_unaff_vs_unaff_df_genename_1, file = "output/res_unaff_vs_unaff_df_sub_genename_padj1.csv")
```
...
filtered_gene_names <- res_unaff_vs_unaff_df_sub_genename$gene_name[!grepl("^ENS", res_unaff_vs_unaff_df_sub_genename$gene_name)]
...
# Save significant genes
write.csv(combined_data, file = "output/res_unaff_vs_unaff_significant_subsetted_mygene.csv", row.names = FALSE)
```
