---
title: "Differential Gene Expression (DGE) Analysis - All Samples"
output:
...
# Add UPF1 to check expression levels
genes_of_interest <- c(genes_of_interest, "UPF1")
...
write.csv(counts_vst, file = "output/counts_vst_all.csv")
mm <- model.matrix(~ Batch + Affected, colData(vsd))

counts_vst_limma <- limma::removeBatchEffect(counts_vst, batch = vsd$Batch, 
                                             design = mm)

write.csv(counts_vst_limma, file = "output/counts_vst_limma_all.csv")
...
```{r, principal-components-analysis-all-affected-status}
...
```{r, principal-components-analysis-all-category}
...
```{r}
res_aff_vs_unaff_all <- results(dds, contrast = c("Affected", "Affected", "Unaffected"))
res_aff_vs_unaff_df_all <- process_and_save_results(
  res_aff_vs_unaff_all,
  "output/res_aff_vs_unaff_all.csv"
)
res_aff_vs_unaff_df_all <- arrange(res_aff_vs_unaff_df_all, padj)
res_aff_vs_unaff_df_05_all <- subset(res_aff_vs_unaff_df_all, padj < 0.05)
res_aff_vs_unaff_df_1_all <- subset(res_aff_vs_unaff_df_all, padj < 0.1)

res_aff_vs_unaff_df_padj1_lfc1_all <- subset(res_aff_vs_unaff_df_1_all, log2FoldChange >= 1 | log2FoldChange <= -1)

summary(res_aff_vs_unaff_all)
```

```{r, top-100-genes-deseq-all, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 100)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)

ensembl_to_gene_all <- setNames(gene_info$gene_name, gene_info$Ensembl_ID)

# Get the current row names of the matrix 'mat'
current_ensembl_ids_all <- rownames(topgenes_aff_vs_unaff_05_all)

# Find the corresponding gene names for the Ensembl IDs
new_row_names_all <- ensembl_to_gene_all[current_ensembl_ids_all]

# Set the new row names for the matrix 'mat'
rownames(topgenes_aff_vs_unaff_05_all) <- new_row_names_all

topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all[order(row.names(topgenes_aff_vs_unaff_05_all)), ]

df_all <- as.data.frame(colData(vsd_limma)[, c("Affected", "Category")])
pheatmap(topgenes_aff_vs_unaff_05_all, annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 5, angle_col = c("0"))
```

```{r, top-100-genes-deseq-all-subcategory, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 100)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
df_all <- as.data.frame(colData(vsd_limma)[, c("Affected", "SubCategory", "Category")])
pheatmap(topgenes_aff_vs_unaff_05_all, annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 5, angle_col = c("0"))
```


```{r, top-50-genes-deseq-all, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 50)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
df_all <- df <- colData(vsd_limma) %>%
  as.data.frame() %>%
  dplyr::select(Category)
pheatmap(topgenes_aff_vs_unaff_05_all, annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 5, angle_col = c("0"))
```

```{r, top-50-genes-deseq-all-subcategory, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 50)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
pheatmap(topgenes_aff_vs_unaff_05_all,
  annotation_col = df_all,
...
```{r, significant-genes-deseq-all, out.height="1000px", out.width ="1200px"}
# Assuming 'res_aff_vs_unaff_df_all' has a column 'padj' for adjusted p-values or 'pvalue' for p-values
# Ensure the row names of 'res_aff_vs_unaff_df_all' are Ensembl IDs
res_aff_vs_unaff_df_all <- res_aff_vs_unaff_df_all[order(res_aff_vs_unaff_df_all$padj), ]
...
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all[order(res_aff_vs_unaff_df_all$padj[topgenes_byensemblid_all]), ]

df_all <- df <- colData(vsd_limma) %>%
  as.data.frame() %>%
  dplyr::select(Category)

png("output/Supplemental Figure 3 - Significant DEGs.png",width=12,height=10,units="in",res=1200)

draw(ComplexHeatmap::pheatmap(topgenes_aff_vs_unaff_05_all, color = colorRampPalette(rev(brewer.pal(n = 9, name =
  "RdYlBu")))(50), annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 6, angle_col = c("0"), cellheight = 10, cellwidth = 24, border_color = "black", heatmap_legend_param = list(
        title = ""
    )))
dev.off()
```

```{r, significant-genes-deseq-all-lfc1, out.height="800px", out.width ="1200px"}
# Assuming 'res_aff_vs_unaff_df_all' has a column 'padj' for adjusted p-values or 'pvalue' for p-values
# Ensure the row names of 'res_aff_vs_unaff_df_all' are Ensembl IDs
res_aff_vs_unaff_df_all <- res_aff_vs_unaff_df_all[order(res_aff_vs_unaff_df_all$padj), ]

# Get the most significant genes based on adjusted p-values and log2foldchange of 1
topgenes_byensemblid_all <- rownames(res_aff_vs_unaff_df_padj1_lfc1_all)
...
ComplexHeatmap::pheatmap(topgenes_aff_vs_unaff_05_all, color = colorRampPalette(rev(brewer.pal(n = 9, name =
  "RdYlBu")))(50), annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 7, angle_col = c("0"), cellheight = 10, cellwidth = 24, border_color = "black", heatmap_legend_param = list(
        title = ""
    ))
```


```{r, significant-genes-deseq-all-subcategory, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 50)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
```{r, significant-genes-deseq-all-subcategory-lfc1, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- rownames(res_aff_vs_unaff_df_padj1_lfc1_all)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
```{r, top-75-genes-deseq-all, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 75)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
pheatmap(topgenes_aff_vs_unaff_05_all,
  annotation_col = df_all,
  annotation_colors = ann_colors2, fontsize = 4, angle_col = c("0")
)
```

```{r, top-75-genes-deseq-all-subcategory, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 75)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
df_all <- as.data.frame(colData(vsd_limma)[, c("Affected", "SubCategory", "Category")])
pheatmap(topgenes_aff_vs_unaff_05_all, annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 4, angle_col = c("0"))
```

```{r, top-200-genes-deseq-all, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 200)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
```{r, top-200-genes-deseq-all-subcategory, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 200)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
df_all <- as.data.frame(colData(vsd_limma)[, c("Affected", "SubCategory", "Category")])
pheatmap(topgenes_aff_vs_unaff_05_all, annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 2.25, angle_col = c("0"))
```

```{r, top-125-genes-deseq-all-all, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 125)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
df_all <- as.data.frame(colData(vsd_limma)[, c("Affected", "Category")])
pheatmap(topgenes_aff_vs_unaff_05_all, annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 3.75, angle_col = c("0"))
```

```{r, top-125-genes-deseq-all-all-subcategory, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 125)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
```{r, top-150-genes-deseq-all-all, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 150)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
df_all <- as.data.frame(colData(vsd_limma)[, c("Affected", "Category")])
pheatmap(topgenes_aff_vs_unaff_05_all, annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 3.5, angle_col = c("0"))
```



```{r, top-150-genes-deseq-all-subcategory, out.height="570px", out.width ="800px"}
topgenes_byensemblid_all <- head(rownames(res_aff_vs_unaff_df_all), 150)
topgenes_aff_vs_unaff_05_all <- assay(vsd_limma)[topgenes_byensemblid_all, ]
topgenes_aff_vs_unaff_05_all <- topgenes_aff_vs_unaff_05_all - rowMeans(topgenes_aff_vs_unaff_05_all)
...
```{r, all-genes-list-all}
gb_df <- genes_biomart[, c(1, ncol(genes_biomart))]
res_aff_vs_unaff_df_all_genename <- res_aff_vs_unaff_df_all
res_aff_vs_unaff_df_all_genename$Ensembl_ID <- row.names(res_aff_vs_unaff_df_all)
res_aff_vs_unaff_df_all_genename <- merge(x = res_aff_vs_unaff_df_all_genename, y = gene_info, by.x = "Ensembl_ID", by.y = "Ensembl_ID", all.x = TRUE)
res_aff_vs_unaff_df_all_genename <- res_aff_vs_unaff_df_all_genename[, c(dim(res_aff_vs_unaff_df_all_genename)[2], 1:dim(res_aff_vs_unaff_df_all_genename)[2] - 1)]
res_aff_vs_unaff_df_all_genename <- res_aff_vs_unaff_df_all_genename[order(res_aff_vs_unaff_df_all_genename[, "padj"]), ]
write.csv(res_aff_vs_unaff_df_all_genename, file = "output/res_aff_vs_unaff_df_all_genename.csv")
```

## Volcano Plot
```{r, volcano-plot, out.height="1000px", out.width ="1200px"}
EnhancedVolcano(res_aff_vs_unaff_df_all_genename,
  lab = res_aff_vs_unaff_df_all_genename$gene_name,
  x = 'log2FoldChange',
  y = 'padj',
  selectLab = c('SLC4A10','SNTG2','TMEM37','KCNQ5','DEFA1'),
...
res_aff_vs_unaff_df_genename_05 <- subset(res_aff_vs_unaff_df_all_genename, padj < 0.05)
res_aff_vs_unaff_df_genename_05 <- res_aff_vs_unaff_df_genename_05[order(res_aff_vs_unaff_df_genename_05$padj), ]
write.csv(res_aff_vs_unaff_df_genename_05, file = "output/res_aff_vs_unaff_df_all_genename_05.csv")
...
write.csv(res_aff_vs_unaff_df_genename_padj05_lfc1, file = "output/res_aff_vs_unaff_df_all_genename_padj05_lfc1.csv")


res_aff_vs_unaff_df_genename_1 <- subset(res_aff_vs_unaff_df_all_genename, padj < 0.1)
res_aff_vs_unaff_df_genename_1 <- res_aff_vs_unaff_df_genename_1[order(res_aff_vs_unaff_df_genename_1$padj), ]
write.csv(res_aff_vs_unaff_df_genename_1, file = "output/res_aff_vs_unaff_df_all_genename_padj1.csv")
...
write.csv(res_aff_vs_unaff_df_genename_padj1_lfc1, file = "output/res_aff_vs_unaff_df_all_genename_padj1_lfc1.csv")
```

Below is a table of information about the top genes.

```{r, padj-gene-info-all}
...
filtered_gene_names <- res_aff_vs_unaff_df_all_genename$gene_name[!grepl("^ENS", res_aff_vs_unaff_df_all_genename$gene_name)]
# Select specific genes to show
# set top = 0, then specify genes using label.select argument
maplot <- ggmaplot(res_aff_vs_unaff_df_all,
  main = "Affected vs Unaffected MA Plot",
  fdr = .1, fc = 1, size = 0.4, # Same used for others.
  genenames = as.vector(res_aff_vs_unaff_df_all_genename$gene_name),
...
```{r, genes-of-interest-table-all}
# Subset gene_info using genes of interest
subset_gene_info <- gene_info[gene_info$gene_name %in% genes_of_interest, ]

filtered_by_interest <- filter(res_aff_vs_unaff_df_all_genename, Ensembl_ID %in% subset_gene_info$Ensembl_ID)
...
df_all <- as.data.frame(colData(vsd_limma)[, c("Affected", "Category")])
pheatmap(mat3, annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 4, angle_col = c("0"))
```
...
rownames(res_aff_vs_unaff_df_all) <- gsub("\\..*", "", rownames(res_aff_vs_unaff_df_all))
res_aff_vs_unaff_df_all <- res_aff_vs_unaff_df_all %>% dplyr::distinct()
geneList <- res_aff_vs_unaff_df_all$log2FoldChange
geneList2 <- res_aff_vs_unaff_df_all$padj
geneList3 <- res_aff_vs_unaff_df_all$padj
names(geneList3) <- rownames(res_aff_vs_unaff_df_all)
names(geneList2) <- rownames(res_aff_vs_unaff_df_all)
names(geneList) <- rownames(res_aff_vs_unaff_df_all)
...
```{r, generate-plot-counts-genes-interest-all}
...
for (ensembl_id in filtered_by_interest$Ensembl_ID) {
  ...
  all_counts_gof <- rbind(all_counts_gof, dp)
  ...
  ggsave(
    filename = paste0(gene_name, "-all-plot-counts.png"),
    path = "output/batch-correction-limma/plot-counts/genes-of-interest-all",
    plot = gene_plot, dpi = 450
  )
}

# Create the faceted plot
faceted_plot <- ggplot(all_counts_gof, aes(x = Affected, y = count, color = Affected)) +
  geom_boxplot() +
  geom_jitter(width = 0.2, size = 1.25) + # Adjust size of the dots
  geom_text_repel(aes(label = SampleID), size = 2) + # Add labels to the dots
...
ggsave(
  filename = "faceted_genes_of_interest_plot_counts_all_samples.png",
  path = "output/batch-correction-limma/plot-counts/genes-of-interest-all",
...
# Loop through each gene to calculate and plot counts
for (ensembl_id in res_aff_vs_unaff_df_genename_05$Ensembl_ID) {
  dp <- plotCounts(dds, gene = ensembl_id, intgroup = "Affected", returnData = TRUE)
  d <- plotCounts(dds, gene = ensembl_id, intgroup = "Affected", returnData = TRUE)
  ...
  ggsave(
    filename = paste0(gene_name, "-all-plot-counts.png"),
    path = "output/batch-correction-limma/plot-counts/padj-05-all",
...
# Save the faceted plot
ggsave(
  filename = "faceted_significant_degs_plot_counts_all_samples.png",
  path = "output/batch-correction-limma/plot-counts/padj-05-all",
  plot = faceted_plot, dpi = 1200 
)
...
```{r, combined-heatmap-genes-interest-all, out.width = "1200px"}
mat3 <- assay(vsd_limma)[filtered_by_interest$Ensembl_ID, ]
rownames(mat3) <- gene_info$gene_name[match(filtered_by_interest$Ensembl_ID, gene_info$Ensembl_ID)]
df_all <- as.data.frame(colData(vsd_limma)[, c("Affected", "Category")])
pheatmap(mat3, annotation_col = df_all, annotation_colors = ann_colors2, fontsize = 4, angle_col = c("0"))
...
```{r, save-data}
save.image(file = "output/all-condition-analysis.RData")
```
