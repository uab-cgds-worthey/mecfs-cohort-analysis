...
ComplexHeatmap::pheatmap(topgenes_aff_vs_unaff_05_sub, color = colorRampPalette(rev(brewer.pal(n = 9, name =
  "RdYlBu")))(50), annotation_col = df_sub, annotation_colors = ann_colors2, fontsize = 7, angle_col = c("0"), cellheight = 10, cellwidth = 24, border_color = "black", heatmap_legend_param = list(
        title = ""
    ))
```
...
df_sub <- as.data.frame(colData(vsd_limma)[, c("Affected", "SubCategory", "Category")])
pheatmap(topgenes_aff_vs_unaff_05_sub, annotation_col = df_sub, annotation_colors = ann_colors2, fontsize = 4, angle_col = c("0"))
```
...
df_sub <- as.data.frame(colData(vsd_limma)[, c("Affected", "SubCategory", "Category")])
pheatmap(topgenes_aff_vs_unaff_05_sub, annotation_col = df_sub, annotation_colors = ann_colors2, fontsize = 2.25, angle_col = c("0"))
```
...
df_sub <- as.data.frame(colData(vsd_limma)[, c("Affected", "Category")])
pheatmap(topgenes_aff_vs_unaff_05_sub, annotation_col = df_sub, annotation_colors = ann_colors2, fontsize = 3.75, angle_col = c("0"))
```
...
df_sub <- as.data.frame(colData(vsd_limma)[, c("Affected", "Category")])
pheatmap(topgenes_aff_vs_unaff_05_sub, annotation_col = df_sub, annotation_colors = ann_colors2, fontsize = 3.5, angle_col = c("0"))
```
...
EnhancedVolcano(res_aff_vs_unaff_df_sub_genename,
...
write.csv(res_aff_vs_unaff_df_genename_padj05_lfc1, file = "output/res_aff_vs_unaff_df_sub_genename_padj05_lfc1.csv")
...
write.csv(res_aff_vs_unaff_df_genename_padj1_lfc1, file = "output/res_aff_vs_unaff_df_sub_genename_padj1_lfc1.csv")
```
...
df_sub <- as.data.frame(colData(vsd_limma)[, c("Affected", "Category")])
pheatmap(mat3, annotation_col = df_sub, annotation_colors = ann_colors2, fontsize = 4, angle_col = c("0"))
```
...
for (ensembl_id in res_aff_vs_unaff_df_genename_05$Ensembl_ID) {
  ...
  ggsave(
    filename = paste0(gene_name, "-all-plot-counts.png"),
    path = "output/batch-correction-limma/plot-counts/padj-05",
